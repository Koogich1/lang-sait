...
const PageLessonNear = ({ lesson }: Props) => {
	...
	return (
		<div className="text-sm flex gap-1 items-center w-full text-gray-400 font-medium py-2 justify-start rounded-lg">
			<p>Ближайшее занятие:</p>
