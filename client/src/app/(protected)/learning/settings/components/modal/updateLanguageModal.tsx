...
import deleteLanguage from "../../actions/deleteLanguage";
...
const UpdateLanguageModal = ({openModal, setOpenModal, language, visov}: Props) => {
            ...
            : ""}
              ...
              {active === "delete" &&
                <div className="text-gray-400 flex flex-col gap-5 mt-3">
                  <p className="text-lg text-red-500 font-medium">Вы действительно хотите удалить этот язык?</p>
