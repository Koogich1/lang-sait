...
const UpdateMultibleChoose = ({ test, updateVisov }: { test: Test, updateVisov: () => void }) => {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex items-center justify-between mt-2">
                  <FormLabel className="w-1/4 text-base font-medium text-gray-400">Вопрос:</FormLabel>
                  <FormControl className="w-3/4 font-medium text-xs">
...
export default UpdateMultibleChoose;
