...
const createTrueVariantsPhotoTest = async ({ lessonId, littleRasdelId }: Props) => {
	...
	const test = await db.test.create({
		data: {
			...
			questionType: "CONNECT_PHOTO_VARIANTS",
			options: {
				create: [
			...
			answers: {
				create: [
					{ text: "https://storage.yandexcloud.net/langschoolacynberg/images/flags/English.png", order: 1 },
					{ text: "https://storage.yandexcloud.net/langschoolacynberg/images/flags/English.png", order: 2 },
				]
			},
			position: position
		}
...
export default createTrueVariantsPhotoTest;