...
import updateImageToOption from "../test/updateImageToOption";
import updateImageToAnswer from "../test/updateImageToAnswer";

export async function s3UpdateAnswerImageConnect(fileBuffer: Buffer, folderName: string, fileName: string, testId: string, currOptionId: string) {
    ...
    try {
        ...
        try{
            console.log("обновление успешно")
						await updateImageToAnswer(currOptionId, testId, question)
        }catch(e){
            console.log(e)
        }
