...
export async function createS3Rasdel(fileBuffer: Buffer, folderName: string, fileName: string, name: string, aboutCourse: string, course: courseData | null) {
    ...
    try {
        ...
        try{
					createRasdel({ name: name, aboutRasdel: aboutCourse, photoUrl: question, course: course});
        }catch(e){
            console.log(e)
        }
