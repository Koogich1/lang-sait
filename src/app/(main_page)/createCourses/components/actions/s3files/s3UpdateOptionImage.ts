...
export async function s3UpdateOptionImage(fileBuffer: Buffer, folderName: string, fileName: string, testId: string, currOptionId: string) {
    ...
    try {
        ...
        try{
            console.log("обновление успешно")
						await updateImageToOption(currOptionId, testId, question)
        }catch(e){
            console.log(e)
        }
